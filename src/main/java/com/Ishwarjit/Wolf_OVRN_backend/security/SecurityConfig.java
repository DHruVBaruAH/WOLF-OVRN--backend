        ...
        public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
                http
                                ...
                                .authorizeHttpRequests(auth -> auth
                                                ...
                                                .requestMatchers(HttpMethod.GET, "/api/fits", "/api/fits/**").permitAll()
                                                .requestMatchers(HttpMethod.POST, "/api/fits").hasRole("ADMIN")
                                                .requestMatchers(HttpMethod.PUT, "/api/fits/*").hasRole("ADMIN")
                                                .requestMatchers(HttpMethod.DELETE, "/api/fits/*").hasRole("ADMIN")
                                                ...
                                                .requestMatchers(HttpMethod.PATCH, "/api/social-links").hasRole("ADMIN")
                                                // Drop Events
